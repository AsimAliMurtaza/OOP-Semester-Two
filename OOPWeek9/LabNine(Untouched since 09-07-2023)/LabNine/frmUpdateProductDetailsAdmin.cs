...
namespace BusinessApp
{
    public partial class frmUpdateProductDetailsAdmin : Form
    {
        ...
        private void cbListLoad_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void frmUpdateProductDetailsAdmin_Load(object sender, EventArgs e)
        {
            ...
            {
                cbListLoad.Items.Add(i.GetProductName());
            }
        }

        private void cbListLoad_Click(object sender, EventArgs e)
        {
            
        }

        private void cbListLoad_MouseClick(object sender, MouseEventArgs e)
        {
        ...
        private void btnUpdateDetails_Click(object sender, EventArgs e)
        {
            ...
            ProductBL prod = ProductDL.GetProductByName(cbListLoad.Text);
